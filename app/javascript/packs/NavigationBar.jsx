            ...
            <Navbar inverse collapseOnSelect fixedTop className="bs-navbar-collapse">
              <Navbar.Header>
                <Navbar.Brand>
                  ...
                  <a style={{color: 'white', fontSize: 40, marginTop: 20}} href="#" onClick={()=>self.changeDivision('Popular')}><Glyphicon glyph="fire" /> MC.net</a>
                </Navbar.Brand>
          ...
          <div>
            <Navbar inverse collapseOnSelect fixedTop className="bs-navbar-collapse">
              <Navbar.Header>
                <Navbar.Brand>
                  {/*<a href="#"><img src="https://i.imgur.com/Xs3GP6z.png" style={{width: '65px', marginBottom: '5px'}} /></a>*/}
                  <a style={{color: 'white'}} href="#" onClick={()=>self.changeDivision('Popular')}><Glyphicon glyph="fire" /> MC.net</a>
                </Navbar.Brand>
